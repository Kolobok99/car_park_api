...
class BaseTestAPIClass:
    ...
    def _test_retrieve__with_valid_url_kwarg_by_UN_privileged_user(self, un_prv_user, base_path_name, valid_url_kwarg):
        """BaseMethod: отправка retrieve-запроса с valid_url_kwarg от НЕ_привилегированного пользователя"""
    ...
    def _test_retrieve__with_valid_url_kwarg_by_privileged_user(self, prv_user, base_path_name, valid_url_kwarg, instance, fields):
        """BaseMethod: отправка retrieve-запроса на brand с valid_url_kwarg от привилегированного пользователя"""
    ...
    def _test_retrieve__with_IN_invalid_url_kwargs_by_privileged_user(self, prv_user, base_path_name, invalid_url_kwargs):
        """BaseMethod: отправка retrieve-запроса с invalid_url_kwargs от привилегированного пользователя"""
    ...
    def _test_create__with_valid_payload_by_privileged_user(self, prv_user, base_path_name, valid_payload, model, start_count):
        ...
        #     assert key in data
        #     assert valid_payload[key] == data[key]
    ...
    def _test_create__with_IN_valid_payload_by_privileged_user(self, prv_user, base_path_name, in_valid_payload, model, start_count):
        ...
        response = self.client.post(url, in_valid_payload)
    ...
    def _test_update__with_valid_payload_by_UN_privileged_user(self, un_prv_user, base_path_name, valid_url_kwargs, valid_payload):
    ...
    def _test_update__with_valid_data_by_privileged_user(self, prv_user, base_path_name, valid_url_kwargs, valid_payload, model, start_count):
    ...
    def _test_update__with_IN_valid_payload_by_privileged_user(self, prv_user, base_path_name, valid_url_kwargs, in_valid_payload, instance, model):
